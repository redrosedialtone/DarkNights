...
namespace Nebula.Input
{
    public class ExecuteEvents
    {
        ...
        public static IPointerEventType ExecuteHierarchy<IPointerEventType>(IPointerEventListener[] Listeners, MouseButtonEventData Data, EventHandle Event) where IPointerEventType : IPointerEventBase
        {
        ...
        public static IPointerEventType GetEventListener<IPointerEventType>(IPointerEventListener[] Listeners, MouseButtonEventData Data, EventHandle Event) where IPointerEventType : IPointerEventBase
        {
            if (Listeners == null || Listeners.Length == 0)
            {
                return default;
        ...
        public static bool ExecuteEvent(IPointerEventBase Event, MouseButtonEventData Data, EventHandle EventType)
        {
            bool _triggered = false;
            switch (EventType)
            {
